...
import { Shield, FileText, CheckCircle, AlertCircle, Download, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Monitor your licensing, contracting, and compliance requirements</p>
      </div>
