...
const LINKS = [
  ...
  {
    key: "surelc_register",
    url: "https://accounts.surancebay.com/oauth/authorize?redirect_uri=https:%2F%2Fsurelc.surancebay.com%2Fproducer%2Foauth%3FreturnUrl%3D%252Fprofile%252Fcontact-info%253FgaId%253D152%2526gaId%253D152%2526phone%253D7076857014%2526branch%253DEverence%252520Wealth%252520LLC%2526branchVisible%253Dtrue%2526branchEditable%253Dfalse%2526branchRequired%253Dtrue%2526dba%253DB%2526autoAdd%253Dfalse%2526requestMethod%253DGET&gaId=152&client_id=surecrmweb&response_type=code",
