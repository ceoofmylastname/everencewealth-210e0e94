  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Manage Marketing Resources</h1>
          <p className="text-sm text-gray-500 mt-0.5">Add and manage resources visible to all agents.</p>
        </div>
