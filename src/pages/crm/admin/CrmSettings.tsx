...
import { Settings, RefreshCw, Loader2, CheckCircle2, XCircle, Mail, Send, AlertCircle, AlertTriangle } from "lucide-react";
          ...
          <div className="pt-2 border-t">
            <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-lg">
              ...
              <div className="text-xs text-muted-foreground">
                <p className="font-medium text-foreground">Email-Only Mode</p>
                <p>All agent notifications are sent via email through Resend.</p>
              </div>
            </div>
          </div>
        </CardContent>
