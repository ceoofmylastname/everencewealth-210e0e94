      ...
      >
        {t.usps.items.map((item, idx) => (
          <motion.div
            ...
            className="bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-100 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 hover:bg-white group"
          >
