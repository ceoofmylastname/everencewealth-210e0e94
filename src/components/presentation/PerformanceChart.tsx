...
const SP500_DATA: DataPoint[] = [
  ...
  { year: 2013, value: 170594.45 },
  { year: 2014, value: 263961.83 },
  { year: 2015, value: 263961.83 },
  { year: 2016, value: 263961.83 },
  { year: 2017, value: 307071.03 },
  { year: 2018, value: 307071.03 },
  { year: 2019, value: 307071.03 },
...
const INDEXED_DATA: DataPoint[] = [
  ...
  { year: 2014, value: 344064.38 },
  { year: 2015, value: 431594.35 },
  { year: 2016, value: 431594.35 },
  ...
  const draw = useCallback(
    (ctx: CanvasRenderingContext2D, w: number, h: number, t: number) => {
      ...
      const drawLine = (
        ...
        // Dedupe: only label the first year of each flat run
        if (i > 0 && data[i].value === data[i - 1].value) continue;

          const label = formatDollar(data[i].value);
          const above = labelAbove;
