  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-end">
        <Button size="sm" onClick={() => setAdding(!adding)} style={{ backgroundColor: "#1A4D3E" }}><Plus className="w-4 h-4 mr-1" /> Schedule</Button>
      </div>
      {adding && (
      ...
      {appts.length === 0 && !adding ? (
        ...
        <div key={a.id} className="bg-white border rounded-lg p-4 flex justify-between items-start">
          <div>
            ...
            {a.location && <div className="text-sm text-gray-600 mt-1">{a.location}</div>}
