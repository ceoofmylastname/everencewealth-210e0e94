...
const CITY_METADATA: Record<string, { avgPrice: string; bestFor: string; vibe: string }> = {
  'los-angeles': { avgPrice: 'High Cost of Living', bestFor: 'Entertainment & Tech', vibe: 'Dynamic' },
  'austin': { avgPrice: 'Moderate Cost of Living', bestFor: 'Tech & Music', vibe: 'Vibrant' },
  'phoenix': { avgPrice: 'Low Cost of Living', bestFor: 'Retirement & Growth', vibe: 'Sunny' },
  'new-york': { avgPrice: 'Very High Cost of Living', bestFor: 'Finance & Culture', vibe: 'Fast-Paced' },
  'chicago': { avgPrice: 'Moderate Cost of Living', bestFor: 'Business & Architecture', vibe: 'Urban' },
  'houston': { avgPrice: 'Low Cost of Living', bestFor: 'Energy & Medical', vibe: 'Diverse' },
  'san-diego': { avgPrice: 'High Cost of Living', bestFor: 'Biotech & Military', vibe: 'Coastal' },
  'dallas': { avgPrice: 'Moderate Cost of Living', bestFor: 'Business & Sports', vibe: 'Ambitious' },
  'miami': { avgPrice: 'High Cost of Living', bestFor: 'International Finance', vibe: 'Tropical' },
  'san-francisco': { avgPrice: 'Very High Cost of Living', bestFor: 'Tech & Innovation', vibe: 'Progressive' },
  'denver': { avgPrice: 'Moderate Cost of Living', bestFor: 'Outdoors & Tech', vibe: 'Active' },
  'seattle': { avgPrice: 'High Cost of Living', bestFor: 'Tech & Nature', vibe: 'Green' },
  'california': { avgPrice: 'High Cost of Living', bestFor: 'Diverse Economy', vibe: 'Golden State' },
  'texas': { avgPrice: 'Low Cost of Living', bestFor: 'Energy & Growth', vibe: 'Big & Bold' },
  'florida': { avgPrice: 'Moderate Cost of Living', bestFor: 'Tourism & Finance', vibe: 'Sunshine' },
  'arizona': { avgPrice: 'Low Cost of Living', bestFor: 'Retirement & Growth', vibe: 'Desert Sun' },
  'colorado': { avgPrice: 'Moderate Cost of Living', bestFor: 'Outdoors & Tech', vibe: 'Mountain' },
  'washington': { avgPrice: 'High Cost of Living', bestFor: 'Tech & Trade', vibe: 'Evergreen' },
  'illinois': { avgPrice: 'Moderate Cost of Living', bestFor: 'Finance & Industry', vibe: 'Heartland' },
  'new-york-state': { avgPrice: 'High Cost of Living', bestFor: 'Finance & Culture', vibe: 'Empire' },
};
