...
export const TFRSpeakable: React.FC = () => {
  ...
  const speakableSchema = { "@context": "https://schema.org", "@type": "SpeakableSpecification", "cssSelector": ".tfr-speakable-content" };
      ...
      <div className="container max-w-5xl mx-auto px-6 relative z-10">
        <GlassCard className="p-10 md:p-16 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.12)]" glow tilt depth>
          <div className="tfr-speakable-content" itemProp="speakable">
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-xl md:text-2xl leading-relaxed text-muted-foreground font-light text-center">{speakableText}</motion.p>
          </div>
