    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]" style={{ background: 'linear-gradient(135deg, hsl(160,48%,14%) 0%, hsl(160,48%,8%) 60%, hsl(160,48%,5%) 100%)' }}>
      ...
      <div className="container max-w-6xl mx-auto px-6 py-24 text-center relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }} className="flex flex-wrap gap-4 justify-center">
          <motion.a href="#ap-cta" whileHover={{ scale: 1.05, boxShadow: '0 0 30px hsla(43,74%,49%,0.4)' }} whileTap={{ scale: 0.98 }} className="px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300" style={{ background: 'linear-gradient(135deg, hsl(43,74%,49%) 0%, hsl(43,74%,55%) 100%)', color: 'hsl(160,48%,12%)' }}>
            {s?.ctaPrimary || 'Get Your Protection Plan'}
          </motion.a>
          <motion.a href="#ap-threats" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="px-8 py-4 rounded-xl font-bold text-lg border border-white/30 text-white hover:bg-white/10 transition-all duration-300">
