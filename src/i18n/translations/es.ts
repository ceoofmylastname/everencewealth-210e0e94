export const es = {
  header: {
    ...
    cities: {
      indexedStrategy: "Estrategias de Vida Universal Indexada",
      annuities: "Ingresos de jubilación libres de impuestos",
      socialSecurity: "Planificación de protección de activos",
      taxDiversification: "Planificación patrimonial y legado",
    },
    language: "Idioma",
    nav: {
  ...
  featuredAreas: {
    ...
    areas: {
      indexedStrategy: "Vida Universal Indexada (IUL) — ingresos de jubilación libres de impuestos con crecimiento vinculado al mercado y protección contra pérdidas.",
      annuities: "Anualidades Fijas e Indexadas — flujos de ingresos garantizados para seguridad en la jubilación con crecimiento diferido de impuestos.",
      rothIra: "Estrategias Roth IRA — crecimiento y retiro libres de impuestos para planificación de jubilación a largo plazo.",
      estatePlanning: "Planificación patrimonial — protegiendo su legado con fideicomisos, designaciones de beneficiarios y estrategias de transferencia de riqueza.",
      longTermCare: "Planificación de cuidado a largo plazo — estrategias de protección de activos para preservar su riqueza contra costos de salud.",
      taxDiversification: "Diversificación de cubetas fiscales — optimizando entre cuentas antes de impuestos, después de impuestos y libres de impuestos.",
      socialSecurity: "Optimización de Seguro Social — estrategias de tiempo para maximizar sus beneficios de por vida.",
      assetProtection: "Protección de activos — protegiendo su patrimonio con estructuras apropiadas y soluciones de seguros.",
      businessSuccession: "Planificación de sucesión empresarial — estrategias para propietarios que se retiran de sus negocios.",
      charitableGiving: "Estrategias de donación benéfica — formas fiscalmente eficientes de apoyar las causas que le importan.",
    },
  },
  process: {
