export const en = {
  header: {
    ...
    cities: {
      indexedStrategy: "Index Strategies",
      annuities: "Tax-free retirement income",
      socialSecurity: "Asset protection planning",
      taxDiversification: "Estate & legacy planning",
    },
    language: "Language",
    nav: {
  ...
  featuredAreas: {
    ...
    areas: {
      indexedStrategy: "Indexed Strategy — tax-free retirement income with market-linked growth and downside protection.",
      annuities: "Fixed & Indexed Annuities — guaranteed income streams for retirement security with tax-deferred growth.",
      rothIra: "Roth IRA strategies — tax-free growth and withdrawal for long-term retirement planning.",
      estatePlanning: "Estate planning — protecting your legacy with trusts, beneficiary designations, and wealth transfer strategies.",
      longTermCare: "Long-term care planning — asset protection strategies to preserve your wealth against healthcare costs.",
      taxDiversification: "Tax bucket diversification — optimizing across pre-tax, after-tax, and tax-free accounts for maximum efficiency.",
      socialSecurity: "Social Security optimization — timing strategies to maximize your lifetime benefits.",
      assetProtection: "Asset protection — shielding your wealth with proper structures and insurance solutions.",
      businessSuccession: "Business succession planning — strategies for owners transitioning out of their businesses.",
      charitableGiving: "Charitable giving strategies — tax-efficient ways to support causes you care about.",
    },
  },
  process: {
    eyebrow: "How We Work",
