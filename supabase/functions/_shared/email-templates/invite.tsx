...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join Everence Wealth</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You've been invited to join Everence Wealth. Click the button below to accept the invitation and create your account.
        </Text>
