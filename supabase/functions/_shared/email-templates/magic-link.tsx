...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your login link for Everence Wealth</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Click the button below to securely log in to your Everence Wealth account. This link will expire shortly.
        </Text>
