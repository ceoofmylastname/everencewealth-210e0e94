          ...
          for (const englishQA of englishQAPages) {
            ...
            const { error: insertError } = await supabase
              ...
              .insert({
                ...
                slug: englishQA.slug,
                canonical_url: `https://www.everencewealth.com/en/qa/${englishQA.slug}`,
            ...
            try {
              ...
              const { error: insertError } = await supabase
                ...
                .insert({
                  ...
                  canonical_url: `https://www.everencewealth.com/${lang}/qa/${translatedQA.slug}`,
    ...
    for (const qaData of allQAPages) {
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          title: qaData.title,
          slug: baseSlug,
          canonical_url: `https://www.everencewealth.com/${qaData.language}/qa/${baseSlug}`,
